...
/* Datatable CSS */
.v-datatable-light-header .header-item {
  cursor: pointer;
  color: #337ab7;
  transition: color 0.15s ease-in-out;
}

.v-datatable-light-header .header-item:hover {
  color: #ed9b19;
}

.v-datatable-light-header .header-item.no-sortable{
  cursor: default;
}
.v-datatable-light-header .header-item.no-sortable:hover {
  color: #337ab7;
}

.v-datatable-light-header .header-item .th-wrapper {
  display: flex;
  width: 100%;
  height: 100%;
  font-weight: bold;
...
.v-datatable-light-header .header-item .th-wrapper.checkboxes {
  justify-content: center;
}

.v-datatable-light-header .header-item .th-wrapper .arrows-wrapper {
  display: flex;
...
.v-datatable-light-header .header-item .th-wrapper .arrows-wrapper.centralized {
  justify-content: center;
}

.v-datatable-light-header .arrow {
  transition: color 0.15s ease-in-out;
  width: 0;
  height: 0;
...
.v-datatable-light-header .arrow.up {
  border-bottom: 8px solid #337ab7;
}

.v-datatable-light-header .arrow.up:hover {
  border-bottom: 8px solid #ed9b19;
}

.v-datatable-light-header .arrow.down {
  border-top: 8px solid #337ab7;
}

.v-datatable-light-header .arrow.down:hover {
  border-top: 8px solid #ed9b19;
}

.v-datatable-light-body .footer {
  display: flex;
  justify-content: space-between;
  width: 500px;
}
...
export default {
  ...
  data: function() {
    return {
      ...
      datatableCss: {
        tableHeader: 'table table-bordered table-hover table-striped table-center',
        tableBody: 'table table-bordered table-hover table-striped table-center',
        th: 'header-item',
