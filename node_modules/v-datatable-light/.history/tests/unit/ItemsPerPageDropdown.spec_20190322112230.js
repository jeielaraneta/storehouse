...
describe('Pagination.vue', () => {
  describe('Rendering tests', () => {
    ...
    it('should render Component with the the option with 20 values selected when `itemsPerPage` props is 20', () => {
      ...
      expect(selectedOption.element.text()).toBe(20)
      // expect(wrapper.findAll('.v-datatable-light-items-per-page')).toHaveLength(3)
      console.log('HTML', wrapper.findAll('.v-datatable-light-items-per-page option').at(1).element.selected);
    })
  })
})