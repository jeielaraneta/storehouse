...
describe('Pagination.vue', () => {
  ...
  describe('Emmit tests', () => {
    it('should emmit onUpdate event returning 30 when select the second option in the select rendered with default props', () => {
      const wrapper = mount(Component)
      expect(wrapper.findAll('option')).toHaveLength(3)
      wrapper.findAll('option').at(1).setSelected()
      const emmited = wrapper.emmited()
      expect(emmited).toBe([['30']])
    })
  })
})