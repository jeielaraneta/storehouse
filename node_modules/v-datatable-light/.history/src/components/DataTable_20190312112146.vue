<template>
  <div>
    ...
    <table class="v-datatable-light-header" :class="css.tableBody">
      <tbody :class="css.tbody">
        <template v-if="isLoading">
          <tr :class="css.tbodyTrSpinner">
            <td :colspan="headers.length" :class="css.tbodyTdSpinner" style="max-width:100px;">
              <slot name="spinner"/>
            </td>
          </tr>
        </template>
        <template v-else-if="data.length">
          <tr v-for="(item, index) in data" :key="index" :class="css.tbodyTr">
            <td v-for="key in headers" :key="`${index}-${key.name}`" :class="css.tbodyTd" style="max-width:100px;">
              <slot
