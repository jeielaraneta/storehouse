				...
				<form method="POST" enctype="multipart/form-data">
					...
					<div class="form-group row">
					    ...
					    <div class="col-sm-8">
					    	...
					    	<input type="text" class="form-control" id="last_name" name="last_name" v-if="toEditBirthday" v-on:click="isHidden = true" :value="this.memberData.birthday" disabled>

					    	<date-picker id="birthday" name="birthday" v-model="birthday" v-bind:value="birthday" v-else :config="options" autocomplete="off"></date-picker>
