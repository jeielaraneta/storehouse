<template>
    <div class="card">
        ...
        <div class="card-body">
            <form ref="createMember" id="createMember" method="POST" :action="this.submitMemberRoute" @submit.prevent="submitForm" @reset.prevent="resetForm" enctype="multipart/form-data" >
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select id="marital_status" class="custom-select custom-select mb-3" name="marital_status" v-model="marital_status" v-validate="'required'" :class="{'form-control': true, error: errors.has('marital_status')}">
                        ...
                        <span class="error text-danger" v-if="errors.has('marital_status')">{{errors.first('marital_status')}}</span>
                    </div>

                    <div class="form-group col-md-4">
                        <label for="membership_status">Membership Status</label>
                        <select id="membership_status" class="custom-select custom-select mb-3" name="membership_status" v-model="membership_status" v-validate="'required'" :class="{'form-control': true, error: errors.has('membership_status')}">
                        ...
                        <span class="error text-danger" v-if="errors.has('membership_status')">{{errors.first('membership_status')}}</span>
                    </div>
                </div>
